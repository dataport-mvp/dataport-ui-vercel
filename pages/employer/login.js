    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* LEFT — teal, matches employer brand */
        ...
        /* Terms checkbox — same pattern as employee login */
        ...
        .terms-row:hover{border-color:rgba(13,110,110,.3);background:#f0f9f4}
        ...
        .sub{padding:.88rem;background:#0d6e6e;color:#fff;border:none;border-radius:9px;font-family:'DM Sans',sans-serif;font-size:.88rem;font-weight:700;cursor:pointer;transition:all .15s;width:100%;margin-bottom:.75rem;box-shadow:0 4px 16px rgba(13,110,110,.22)}
      ...
      <div className="pg">
        ...
        <div className="lft">
          <Link href="/" className="lft-logo">
            ...
            <div>
              <div className="lft-logo-name">Datagate</div>
              <div className="lft-logo-sub">Verified Employment</div>
            </div>
          </Link>
          ...
          <div className="lft-body">
            ...
            <div className="feats">
              {["Request employee consent in one click",
                "Verified identity, education, and employment records",
                "EPFO-linked employment history — not self-reported",
                "Full consent audit trail for every access"].map(f=>(
        ...
        <div className="rgt">
          <div className="form">
            ...
            {mode==="signup" && (
              <div className="fld">
                <label className="flb">Company Name <span>*</span></label>
                <input className="fin" placeholder="Acme Technologies Pvt. Ltd." value={company} onChange={e=>setCompany(e.target.value)}/>
              </div>
            )}

            <div className="fld">
              <label className="flb">Work Email <span>*</span></label>
              <input className="fin" type="email" placeholder="hr@yourcompany.com" value={email} onChange={e=>setEmail(e.target.value)}/>
            </div>

            <div className="fld">
              <label className="flb">Password <span>*</span></label>
            ...
            <div className="tgl">
              ...
              <button className="tgb" onClick={()=>{setMode(mode==="login"?"signup":"login");setError("");setTermsAgreed(false)}}>
