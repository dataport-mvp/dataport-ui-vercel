...
export default function BgvLogin() {
  ...
  const handle = async () => {
    ...
    try {
      ...
      if (data.role !== "bgv") {
        setError("This portal is for BGV vendors only.");
        setLoading(false);
        return;
      }
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        /* LEFT — warm neutral, same family as employee login */
        ...
        .fsb{font-size:.83rem;color:#b8b3c2;margin-bottom:1.75rem;line-height:1.6}
        ...
        .fin:focus{border-color:#0d6e6e;background:#fff;box-shadow:0 0 0 3px rgba(13,110,110,.07)}
        ...
        .terms-row:hover{border-color:rgba(13,110,110,.25);background:#f0f9f4}
        ...
        .submit{padding:.88rem;background:#0d6e6e;color:#fff;border:none;border-radius:9px;font-family:'DM Sans',sans-serif;font-size:.9rem;font-weight:700;cursor:pointer;transition:all .15s;width:100%;margin-bottom:.75rem;box-shadow:0 4px 16px rgba(13,110,110,.22)}
          ...
          <div className="form-wrap">
            ...
            {registered && (
              <div className="alert-success">
                ✅ <strong>Registration submitted.</strong> Your account is pending admin approval. You will receive an email once approved. Contact support@datagate.co.in if urgent.
              </div>
            )}

            {pending && (
              <div className="alert-warn">
                ⏳ <strong>Account pending approval.</strong> Datagate admin will review your BGV vendor account. Contact <strong>support@datagate.co.in</strong> if urgent.
              </div>
            )}
