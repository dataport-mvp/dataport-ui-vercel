...
const STEP_DONE_BG = "#f5f3ff";
const STEP_DONE_CK = "#7c3aed";
const STEP_CONN    = "#ddd6fe";
const STEP_SHADOW  = "rgba(124,58,237,0.28)";
...
const G = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .emp-card { background: #fff; border-radius: 14px; padding: 1.5rem 1.6rem; margin-bottom: 1.1rem;
    box-shadow: 0 2px 12px rgba(79,70,229,0.07), 0 0 0 1px #ebe9f5; position: relative; overflow: hidden; }
  .emp-card::before { content: ''; position: absolute; top: 0; left: 0; bottom: 0;
    width: 4px; border-radius: 14px 0 0 14px; background: #4f46e5; }
  ...
  .decl-card { background: #fff; border-radius: 14px; padding: 1.5rem 1.6rem; margin-bottom: 1.1rem;
    box-shadow: 0 2px 12px rgba(79,70,229,0.07), 0 0 0 1px #ebe9f5; position: relative; overflow: hidden; }
  .decl-card::before { content: ''; position: absolute; top: 0; left: 0; bottom: 0;
  ...
  .ta { padding: 0.65rem 0.875rem; background: #f8f9fc; border: 1.5px solid #e4e2ed;
    border-radius: 9px; font-family: inherit; font-size: 0.875rem; color: #1e293b;
...
// ─── StepNav — P3 active accent: VIOLET ──────────────────────────────
