...
export default function UANPage() {
  ...
  const removePfRecord = (index) => {
    if (index === 0) return;
    const updated = form.pfRecords.filter((_, i) => i !== index);
    setForm({ ...form, pfRecords: updated });
  };
          ...
          <div style={styles.row}>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateUan("mobileLinked", e.target.value.replace(/\D/g, ""))
                }
              />
            </div>
              ...
              <div style={styles.row}>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updatePf(index, "companyName", e.target.value)
                    }
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updatePf(index, "pfMemberId", e.target.value)
                    }
                  />
                </div>
              </div>
